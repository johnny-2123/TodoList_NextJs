...
const Login = () => {
  ...
  return (
    <div className="flex-1 text-xs sm:text-sm flex flex-col justify-center items-center gap-2 sm:gap-4">
      ...
      {error && (
        <div className="w-full max-w-[40ch] border text-center border-solid border-rose-400 text-rose-400 py-2">
          {error}
        </div>
      )}
      <input
        ...
        className="outline-none duration-300 border-b-2 border-solid border-white focus:border-cyan-300 text-slate-900 p-2 w-full max-w-[40ch] mt-2"
      />
      <input
        ...
        className="outline-none uration-300 border-b-2 border-solid border-white focus:border-cyan-300  text-slate-900 p-2 w-full max-w-[40ch] mt-2"
      />
      <button
